...
namespace SocialNetApp.Migrations
{
    ...
    [Migration("20250603195412_mssql.onprem_migration_398")]
    partial class mssqlonprem_migration_398
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SocialNetApp.Data.Models.Friend", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SocialNetApp.Data.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SocialNetApp.Data.Models.Friend", b =>
                {
                    b.HasOne("SocialNetApp.Data.Models.User", "CurrentFriend")
                        .WithMany()
                        .HasForeignKey("CurrentFriendId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SocialNetApp.Data.Models.User", "User")
                        .WithMany("Friends")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
